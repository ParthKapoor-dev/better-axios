            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  interceptors, and clean error handling out of the box.
                </TextEffect>
                ...
                >
                  ...
                  >
                    <Link href="https://www.npmjs.com/package/@parthkapoor-dev/better-axios">
                      <span className="text-nowrap">Install Better-Axios</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
